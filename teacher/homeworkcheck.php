...
<div class="row content">
	<div class="col-sm-2 sidenav">
		...
		<a class="dropdown-btn"><i class="fas fa-edit dropdown-toggle"></i>&nbsp;&nbsp;&nbsp;Assignments &nbsp;&nbsp;&nbsp;<span class="caret"></span></a>
	  	<div class="dropdown-container">
		    ...
		    <a href="../teacher/homeworkcheck.php" class="active"><i class="fas fa-check"></i>&nbsp;&nbsp;&nbsp;Check the Work</a>
		</div>
	...
	<div class="col-sm-10 description">
		<div class="page-header title">Check the Homework<p class="home-tagline">Check the assignments</p></div>
